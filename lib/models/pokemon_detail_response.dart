...
//
//     final pokemonDetailResponse = pokemonDetailResponseFromMap(jsonString);
...
class PokemonDetailResponse {
    ...
    factory PokemonDetailResponse.fromJson(String str) => PokemonDetailResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PokemonDetailResponse.fromMap(Map<String, dynamic> json) => PokemonDetailResponse(
